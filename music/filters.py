...
# Each preset is a partial Lavalink "filters" payload.
FILTERS: Dict[str, Dict[str, Any]] = {
    ...
    "earrape": {
        "equalizer": [{"band": i, "gain": 0.5} for i in range(15)],
        "distortion": {
            "sinOffset": 0.0,
            "sinScale": 1.0,
            "cosOffset": 0.0,
...
def get_filter_payload(name: str) -> Optional[Dict[str, Any]]:
...
def reset_filters_payload() -> Dict[str, Any]:
    return dict(_RESET_PAYLOAD)
